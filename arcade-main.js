...
function feelingLucky(){var u=LUCKY_URLS[Math.floor(Math.random()*LUCKY_URLS.length)];var a=document.createElement('a');a.href=u;a.target='_blank';a.rel='noopener noreferrer';document.body.appendChild(a);a.click();document.body.removeChild(a);}
